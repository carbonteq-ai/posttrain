"""Tracked project source selection for provider-free pack planning."""
...
class ProjectPackConfig:
    """Committed project source selection with explicit caller overrides."""
...
def load_project_pack_config(
    ...
    *,
    ...
    """Load `[tool.posttrain.pack]`; explicit caller values win when supplied."""
...
__all__ = ["ProjectPackConfig", "load_project_pack_config"]
