...
def test_prefix_caching_is_validated_and_forwarded(qwen_screen_binding: InferenceBinding) -> None:
    binding = replace(
        qwen_screen_binding,
        engine={**qwen_screen_binding.engine, "enable_prefix_caching": True},
    )
