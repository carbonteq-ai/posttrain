...
def test_dense_qwen_without_layer_types_is_all_full_attention() -> None:
    qwen3_4b = {"num_hidden_layers": 36, "num_attention_heads": 32, "num_key_value_heads": 8, "head_dim": 128, "hidden_size": 2560}
...
def test_draft_model_weights_and_kv_come_out_of_the_budget() -> None:
    gemma = Architecture(parameters=12_000_000_000, hidden_size=3_840, layers=48, attention_layers=8, kv_heads=8, head_dim=256, sliding_window_layers=40, sliding_window=1_024)
    assistant = Architecture(parameters=420_000_000, hidden_size=1_024, layers=4, attention_layers=4, kv_heads=1, head_dim=256)
...
def test_native_mtp_layers_add_kv_without_draft_weights() -> None:
    qwen = Architecture(parameters=2_000_000_000, hidden_size=2_048, layers=24, attention_layers=6, kv_heads=2, head_dim=256, recurrent_layers=18, mtp_layers=1)
...
def test_other_engines_on_the_device_shrink_the_share() -> None:
    lfm = Architecture(parameters=2_600_000_000, hidden_size=2_048, layers=30, attention_layers=8, kv_heads=8, head_dim=64, recurrent_layers=22)
