...
- [ ] Milestone 9 run: `train/lfm2.5-2.6b/automationbench-vortex-20-local-v2` (VORTEX v1 settings on the new stack with the CUDA-graph c40 rollout profile) against the v1 qualification run `pt-2c092d442e9b2085151e0c33`, then the matched held-out evaluation.
