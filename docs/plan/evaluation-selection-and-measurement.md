...
- [ ] Amend the canonical evaluation contracts before implementing new semantics.
- [ ] Qualify pre-execution task inventory and exact native task dispatch against pinned Verifiers.
- [ ] Implement typed selection policies and reusable immutable evaluation manifests.
...
The primary checkout is dirty with unrelated release and curriculum work. Planning inspected HEAD `756f943d41db8c7c469e24a4034d196be2071d8f`; preserve all existing changes. The eval dependency pins Verifiers `36eac9d5e04ef29b584b6fa4f027af00cd76ea19`. Sibling `../verifiers` is on `codex/carbonteq-verifiers-latest` at `1f6793f7d46e8a650a54b2a585193b4010578fa6`, with origin `carbonteq-ai/verifiers`. Its HEAD is not the executable dependency authority.
...
Revision 2 delivers the implementation specification, including the Observatory product and query path. No framework changes, migrations, qualification jobs, or checkpoint evaluations have been performed by this plan. Future updates must distinguish tested behavior from proposed interfaces and record exact backend pins and evidence links.
