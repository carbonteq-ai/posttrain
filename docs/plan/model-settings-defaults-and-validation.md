...
No fork change is required merely to resolve and validate configuration. If M3 proves a native library change necessary, first resolve that fork's current branch, dirty state, upstream base, manifest selection, and lock. At this plan checkpoint, the inspected TRL candidate was `/home/hammad/projects/trl-async-training` at local committed tip `278af512459b6be6d9510029ad9bbfd7d7faff03`, which was not yet pushed or packaged; Verifiers was `/home/hammad/projects/verifiers` at `36eac9d5e04ef29b584b6fa4f027af00cd76ea19`. These development sources were not equivalent to the released dependency selection: the inspected eval/data/train manifests still selected Verifiers `c6c0097ad21da845c62e4b19aba80ef6633e4d9f`. Re-derive every active pin at implementation time. Follow `docs/tooling/forks.md`: generic fix and regression in the owning fork, fork ledger, tests, commit/push and publication, consumer pin/lock, consumer tooling page, then immutable qualification. Do not introduce fork changes speculatively.
