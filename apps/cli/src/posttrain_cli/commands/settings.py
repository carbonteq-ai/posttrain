...
def register(app: typer.Typer) -> None:
    ...
    def settings_suggest_cmd(
        ctx: typer.Context,
        model: Annotated[str | None, typer.Option("--model", help="catalog model variant, e.g. models/lfm2.5-2.6b@bf16")] = None,
        target: Annotated[str | None, typer.Option("--target", help="catalog execution target")] = None,
        memory_gb: Annotated[float | None, typer.Option("--memory-gb", help="GPU memory instead of the target's")] = None,
        ...
        colocated_trainer_gb: Annotated[
            float | None, typer.Option("--colocated-trainer-gb", help="memory a colocated trainer keeps during rollouts")
        ] = None,
        ...
        hardware = Hardware(
            ...
            accelerator_count=gpus or (declared.accelerator_count if declared is not None and declared.accelerator_count else 1),
