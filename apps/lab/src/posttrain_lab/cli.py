    ...
    if args.job == "foundation-qwen-smoke":
        ...
        if automationbench:
            ...
            inference = _selection(
                catalog,
                "inference",
                "inference/qwen3.5-0.8b-vllm-distill-rollout@4",
                InferenceBinding,
            )
            inference = replace(
                inference,
        ...
        model = _adapter_variant(qwen, remote, args.peft)
        inference = replace(
            _selection(catalog, "inference", "inference/qwen3.5-2b-vllm-eval@3", InferenceBinding),
        ...
        inference_id = "inference/qwen3.5-2b-vllm-eval@3" if model is qwen else "inference/lfm2.5-1.2b-vllm-eval@1"
