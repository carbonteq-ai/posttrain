...
def test_every_temporary_script_and_lab_dependent_fixture_has_one_owner_and_exit_criterion() -> None:
    ...
    assert {surface["id"] for surface in surfaces} == {
        ...
        "general-episode-prompt-calibration",
        "trl-async-verifiers-qualification",
        "lfm26-algorithm-comparison",
        "episode-replay-gate",
        "audit-deterministic-inputs",
        "audit-scalar-grpo",
        "audit-structured-toy",
        "audit-verl-deterministic",
        "automationbench-deterministic",
        "author-openrouter-episode-prompt",
        "calibrate-openrouter-episode-judge",
        "compare-episode-judge-vllm-benchmarks",
        "compare-episode-judges",
        "debug-openrouter-gpt5mini-transport",
        "deterministic-turn-fixture",
        "episode-reward-profile",
        "episode-judge-vllm-benchmark",
        ...
        "test-deterministic-turn-fixture",
        "test-episode-reward-audit",
        "test-episode-reward-profile",
        "test-episode-judge-vllm-benchmark",
