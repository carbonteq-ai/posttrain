...
def test_automationbench_grpo_environment_is_category_and_budget_driven() -> None:
    ...
    assert environment.source.revision == "144051d5e89e07de089cce4253357fbede69bd95"
...
def test_lfm26_three_step_qualification_retains_a_12k_episode_budget() -> None:
    ...
    assert judges[0]["code_revision"] == "144051d5e89e07de089cce4253357fbede69bd95"
...
def test_general_capability_catalog_and_library_qualification_are_pinned() -> None:
    ...
    for item in plan.environments:
        ...
        assert item.source.revision == "144051d5e89e07de089cce4253357fbede69bd95"
