...
from posttrain.train import QWEN35_GRPO_SMOKE, PolicySampling, PolicyTurnRequest
...
def test_trl_policy_generator_reuses_loaded_trainer_and_preserves_exact_tokens(monkeypatch) -> None:
    ...
    profile = replace(QWEN35_GRPO_SMOKE, max_completion_length=2, temperature=0.7, top_p=0.9)
    generator = TrlPolicyGenerator(FakeTrainer(), object(), QWEN_35_2B, profile)
